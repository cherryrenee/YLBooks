...
!!! note "이 부록은"
    책에 나온 **🗣️ 프롬프트(AI에게 하는 말)**를 차시별로 한곳에 모았습니다. 필요한 것을 찾아 그대로 복사해 씁니다.


---


## D.1 서문 · 말만 하면 게임이 만들어집니다
...
## D.8 8차시 · 갤러리① Codex — 챗GPT 계정으로 바로 쓰는 AI 코딩 도구
...
## D.9 9차시 · 갤러리② OpenCode — 여러 AI를 골라 쓰는 만능 리모컨
...
## D.10 10차시 · 갤러리③ Antigravity — 버튼과 채팅창으로 만드는 AI 코딩
