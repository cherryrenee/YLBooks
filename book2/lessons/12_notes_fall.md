...
!!! quote "🗣️ 이대로 입력해 확인합니다 (새 터미널 창에서)"
    ```
...
### 12.2.2 단계 ② 세로줄(레인) 4개를 만들어 달라고 부탁합니다
...
승인을 물어보면 엔터로 진행합니다. 끝나면 브라우저를 확인합니다. 새로고침을 안 눌러도 화면에 4개의 줄과 화살표가 나타나 있을 것입니다.
...
!!! warning "⚠️ 조심 — 화면이 안 바뀌면"
    잠깐 기다려도 그대로면, 브라우저 창을 한 번 눌러 클릭해 확인합니다. 그래도 안 바뀌면 그 창에서 `F5`(새로고침)를 눌러 확인합니다. 여전히 이상하면 5분 룰 — 화면을 그대로 두고 Claude Code에게 "화면이 안 바뀌었어, 확인해줘"라고 말합니다.

### 12.2.3 단계 ③ 노트가 떨어지게 부탁합니다
...
!!! warning "⚠️ 조심 — 지금은 키를 눌러도 반응이 없고 소리도 나지 않습니다"
    당연합니다! 방향키를 눌러서 노트를 맞추는 기능은 아직 만들지 않았고, 음악 소리 역시 15차시에서 얹게 됩니다. "왜 소리도 안 나고 키를 눌러도 안 맞아요?"라고 걱정하지 마십시오. 바로 다음 단계들에서 순서대로 만듭니다.
