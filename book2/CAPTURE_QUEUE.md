...
| c04-f03 | cd로 rhythm-game 폴더에 이동한 터미널 화면 | (기존 c03_ps_open.png 대체) 4차시용 경로 확인 화면 촬영 필요 |
| c15_2-f01 | 배경 영상(BGA)이 켜진 게임 화면 | 15-2차시 커스텀 배경 영상 캡처 필요 |
| c15_2-f02 | 채보 녹음 후 JSON 텍스트 박스가 노출된 화면 | 15-2차시 노트 채보 캡처 필요 |
| c16-f01 | 방향키 색깔이 다르게 꾸며진 네온 시작화면 | (기존 game_start.png 대체) 16차시용 꾸며진 화면 촬영 필요 |
